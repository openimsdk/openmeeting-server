...
var file_health_check_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x4d, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x2e, 0x72, 0x74,
	0x63, 0x22, 0x1c, 0x0a, 0x08, 0x50, 0x69, 0x6e, 0x67, 0x42, 0x6f, 0x64, 0x79, 0x12, 0x10, 0x0a,
	0x03, 0x73, 0x74, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x73, 0x74, 0x72, 0x32,
	0x40, 0x0a, 0x06, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x12, 0x36, 0x0a, 0x04, 0x50, 0x69, 0x6e,
	0x67, 0x12, 0x15, 0x2e, 0x4d, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x2e, 0x72, 0x74, 0x63, 0x2e,
	0x50, 0x69, 0x6e, 0x67, 0x42, 0x6f, 0x64, 0x79, 0x1a, 0x15, 0x2e, 0x4d, 0x65, 0x65, 0x74, 0x69,
	0x6e, 0x67, 0x2e, 0x72, 0x74, 0x63, 0x2e, 0x50, 0x69, 0x6e, 0x67, 0x42, 0x6f, 0x64, 0x79, 0x22,
...
var file_health_check_proto_goTypes = []interface{}{
	(*PingBody)(nil), // 0: Meeting.rtc.PingBody
}
var file_health_check_proto_depIdxs = []int32{
	0, // 0: Meeting.rtc.Health.Ping:input_type -> Meeting.rtc.PingBody
	0, // 1: Meeting.rtc.Health.Ping:output_type -> Meeting.rtc.PingBody
...
func (c *healthClient) Ping(ctx context.Context, in *PingBody, opts ...grpc.CallOption) (*PingBody, error) {
	out := new(PingBody)
	err := c.cc.Invoke(ctx, "/Meeting.rtc.Health/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedHealthServer) Ping(context.Context, *PingBody) (*PingBody, error) {
...
func _Health_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Meeting.rtc.Health/Ping",
	}
...
var _Health_serviceDesc = grpc.ServiceDesc{
	ServiceName: "Meeting.rtc.Health",
