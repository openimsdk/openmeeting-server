...
func (x *NotifyMeetingHostData) Reset() {
	*x = NotifyMeetingHostData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_meeting_meeting_proto_msgTypes[44]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*NotifyMeetingHostData) Descriptor() ([]byte, []int) {
	return file_meeting_meeting_proto_rawDescGZIP(), []int{44}
}
...
var file_meeting_meeting_proto_rawDesc = []byte{
	...
	0x74, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x22, 0x9f, 0x01, 0x0a, 0x15, 0x4e, 0x6f,
	0x74, 0x69, 0x66, 0x79, 0x4d, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x48, 0x6f, 0x73, 0x74, 0x44,
	0x61, 0x74, 0x61, 0x12, 0x26, 0x0a, 0x0e, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x55,
	0x73, 0x65, 0x72, 0x49, 0x44, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x6f, 0x70, 0x65,
	0x72, 0x61, 0x74, 0x6f, 0x72, 0x55, 0x73, 0x65, 0x72, 0x49, 0x44, 0x12, 0x2a, 0x0a, 0x10, 0x6f,
	0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x4e, 0x69, 0x63, 0x6b, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x4e,
	...
	0x1a, 0x0a, 0x08, 0x68, 0x6f, 0x73, 0x74, 0x54, 0x79, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x08, 0x68, 0x6f, 0x73, 0x74, 0x54, 0x79, 0x70, 0x65, 0x32, 0xf9, 0x0c, 0x0a, 0x0e,
	...
	0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x42, 0x3e, 0x5a, 0x3c, 0x67, 0x69, 0x74, 0x68, 0x75,
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6f, 0x70, 0x65, 0x6e, 0x69, 0x6d, 0x73, 0x64, 0x6b, 0x2f,
	0x6f, 0x70, 0x65, 0x6e, 0x6d, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x2d, 0x73, 0x65, 0x72, 0x76,
...
var file_meeting_meeting_proto_msgTypes = make([]protoimpl.MessageInfo, 45)
var file_meeting_meeting_proto_goTypes = []interface{}{
	...
	(*pbwrapper.StringValue)(nil),                // 45: openmeeting.pbwrapper.StringValue
	(*pbwrapper.Int64Value)(nil),                 // 46: openmeeting.pbwrapper.Int64Value
	(*pbwrapper.BoolValue)(nil),                  // 47: openmeeting.pbwrapper.BoolValue
}
var file_meeting_meeting_proto_depIdxs = []int32{
	...
	45, // 19: openmeeting.meeting.UpdateMeetingRequest.title:type_name -> openmeeting.pbwrapper.StringValue
	46, // 20: openmeeting.meeting.UpdateMeetingRequest.scheduledTime:type_name -> openmeeting.pbwrapper.Int64Value
	46, // 21: openmeeting.meeting.UpdateMeetingRequest.meetingDuration:type_name -> openmeeting.pbwrapper.Int64Value
	45, // 22: openmeeting.meeting.UpdateMeetingRequest.password:type_name -> openmeeting.pbwrapper.StringValue
	45, // 23: openmeeting.meeting.UpdateMeetingRequest.timeZone:type_name -> openmeeting.pbwrapper.StringValue
	4,  // 24: openmeeting.meeting.UpdateMeetingRequest.repeatInfo:type_name -> openmeeting.meeting.MeetingRepeatInfo
	47, // 25: openmeeting.meeting.UpdateMeetingRequest.canParticipantsEnableCamera:type_name -> openmeeting.pbwrapper.BoolValue
	47, // 26: openmeeting.meeting.UpdateMeetingRequest.canParticipantsUnmuteMicrophone:type_name -> openmeeting.pbwrapper.BoolValue
	47, // 27: openmeeting.meeting.UpdateMeetingRequest.canParticipantsShareScreen:type_name -> openmeeting.pbwrapper.BoolValue
	47, // 28: openmeeting.meeting.UpdateMeetingRequest.disableCameraOnJoin:type_name -> openmeeting.pbwrapper.BoolValue
	47, // 29: openmeeting.meeting.UpdateMeetingRequest.disableMicrophoneOnJoin:type_name -> openmeeting.pbwrapper.BoolValue
	47, // 30: openmeeting.meeting.UpdateMeetingRequest.canParticipantJoinMeetingEarly:type_name -> openmeeting.pbwrapper.BoolValue
	47, // 31: openmeeting.meeting.UpdateMeetingRequest.lockMeeting:type_name -> openmeeting.pbwrapper.BoolValue
	47, // 32: openmeeting.meeting.UpdateMeetingRequest.audioEncouragement:type_name -> openmeeting.pbwrapper.BoolValue
	47, // 33: openmeeting.meeting.UpdateMeetingRequest.videoMirroring:type_name -> openmeeting.pbwrapper.BoolValue
	31, // 34: openmeeting.meeting.GetPersonalMeetingSettingsResp.setting:type_name -> openmeeting.meeting.PersonalMeetingSetting
	47, // 35: openmeeting.meeting.SetPersonalMeetingSettingsReq.cameraOnEntry:type_name -> openmeeting.pbwrapper.BoolValue
	47, // 36: openmeeting.meeting.SetPersonalMeetingSettingsReq.microphoneOnEntry:type_name -> openmeeting.pbwrapper.BoolValue
	...
	47, // 41: openmeeting.meeting.OperateRoomAllStreamReq.cameraOnEntry:type_name -> openmeeting.pbwrapper.BoolValue
	47, // 42: openmeeting.meeting.OperateRoomAllStreamReq.microphoneOnEntry:type_name -> openmeeting.pbwrapper.BoolValue
	45, // 43: openmeeting.meeting.SetMeetingHostInfoReq.hostUserID:type_name -> openmeeting.pbwrapper.StringValue
...
func file_meeting_meeting_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_meeting_meeting_proto_msgTypes[44].Exporter = func(v interface{}, i int) interface{} {
